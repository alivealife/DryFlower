      ...
      <div class="row">
        <div class="col-md-6 pt-5 mb-5">
          <div class="side-wrap shadow">
            <img src="../../assets/images/peter-bucks-TSoShIT8mO4-unsplash (1).jpg" alt="" class="side-img">
        ...
        <div class="col-md-6" v-if="!contactStatus">
          <ValidationObserver class="text-secondary" ref="observer" v-slot="{ invalid }" tag="form"
            ...
            <div class="form-row mb-3">
              <ValidationProvider name="姓名" rules="required" v-slot="{ errors }" class="col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="username" placeholder="輸入姓名"
                  v-model="form.user.name" :class="{'is-invalid': errors[0]}">
              ...
              <ValidationProvider name="電話" rules="required|min:10" v-slot="{ errors }" class="col-md-6">
                ...
                <input type="tel" class="form-control" id="usertel" placeholder="請輸入電話"
                  v-model="form.user.tel" :class="{'is-invalid': errors[0]}">
                <span class="text-danger">{{ errors[0] }}</span>
              </ValidationProvider>
            </div>
            <div class="form-group">
              <ValidationProvider name="Email" rules="required|email" v-slot="{ errors }" ref="emailField">
                ...
                <input type="email" class="form-control" name="email" id="useremail" placeholder="請輸入 Email"
                  v-model="form.user.email" :class="{'is-invalid': errors[0]}">
                <span class="text-danger">{{ errors[0] }}</span>
              </ValidationProvider>
            </div>
            <div class="form-group">
            ...
            <div class="text-right">
              <button class="btn btn-main btn-block" :disabled="invalid"><i class="fas fa-envelope"></i> 連絡我們</button>
            </div>
          </ValidationObserver>
        </div>
