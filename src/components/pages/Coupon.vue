          ...
          <div class="modal-body">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control" id="percent_off" v-model="tempCoupon.percent"
                  placeholder="請輸入折扣數">
              </div>
              <div class="form-group col-md-6">
                <label for="code">Code</label>
                <input type="text" class="form-control" id="code" v-model="tempCoupon.code" placeholder="請輸入 Code">
              </div>
            </div>
            <hr>
            <div class="form-group">
    ...
    methods: {
      ...
      openModal(isNew, item) {
        ...
        if (isNew) {
          ...
          const couponDate = new Date(vm.tempCoupon.due_date * 1000).toISOString().split('T');
          // 經過上面的處理後 couponDate 會變成一個陣列
          // 0 - 儲存年月日
          // 1 - 儲存時間
          vm.last_date = couponDate[0];
          this.isNew = false;
        }
